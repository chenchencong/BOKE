...
<html>
	<head>
		<meta charset="utf-8" />
		<title>欢迎进入博客</title>
		<link rel="stylesheet" type="text/css" href="css_messageindex.css"/>
	 	<script type="text/javascript" src="AjaxRequest1.js" ></script>
		<script type="text/javascript" src="js_messageindex.js" ></script> 
	...
	<body>
        ...
        <div class="outer">
				             ...
				             <div class="username">${sessionScope.user.username}的博客</div>
				              <div class="userinfo">
				               ...
				               <div class="useroption">
				              		<a  class="option" href="submitmessage.jsp">留言</a>
				              </div>
		             </div>
			...
			<div class="center_right">
			     ...
			     <div  id="accpetmessage"  class="centerc" onclick="clickacceptmessage()" >收件箱</div>
                   <div  id="sendmessage"  class="centern" onclick="clicksendmessage()" >发件箱</div>
				...
				<!-- 
	                 <li class="li">
	                  <div class="li_left" >
	                  <a class="li_left_a" >dagdskgadlkgdsklgadsaa</a>
	                  </div>
	                   <div class="li_right" >
	                     <div class="deal">sagkladjvskdljgskadljkKJFLfljknfkldsnfksldnfkdsnlkfjdsjkfj
	                     ksjalfjsadk</div>
