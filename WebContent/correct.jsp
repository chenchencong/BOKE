...
<title>欢迎进入博客</title>
<link rel="stylesheet" type="text/css" href="css_submit.css" />
</head>
<body>
        ...
        <div class="navWrap">
            <div class="nav">
                <ul class="homeNav">
                    ...
                    <li><a class="normal" href="专题中心.html">专题中心</a></li>
                    <li><a class="normal" href="最新文章.html">最新文章</a></li>
...
function checkinfo(){
	...
	return true;
		...
		<form action="data_updateboke" method="post" onsubmit="return checkinfo()">
			<div class="b">
				   
					<div class="b_word">文章标题</div> 
					
					<input class="wenben" id="title" type="text" name="title" value="${sessionScope.correctdata.title}"/>
					 <div class="b_word">文章内容</div> 

					<textarea id="article"class="zhengwen" rows="3" cols="20" name="content" >${sessionScope.correctdata.content}</textarea>
				      <div class="sr">
