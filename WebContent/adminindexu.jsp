...
<html>
	<head>
		<meta charset="utf-8" />
		<title>欢迎进入博客</title>
		<link rel="stylesheet" type="text/css" href="css_adminindex.css"/>
	 	<script type="text/javascript" src="AjaxRequest1.js" ></script>
		<script type="text/javascript" src="js_adminindexu.js" ></script> 
	...
	<body>
        ...
        <div class="outer">
			<div class="inner" id="inner">
		         ...
		         <div class="user">
		             ...
		             <div class="divuserinfo">
				             <div class="username">${sessionScope.user.username}的主页</div>
				              <div class="userinfo">
			...
			<div class="center_right">
			     ...
			     <a class="center_right_title_gl"style="margin-top:5px;"href="adminindex.jsp" >博客管理</a>
                   <a class="center_right_title_gl" style="height:39px;width:102px; line-height:39px;"href="adminindexu.jsp">用户管理</a>
                   <a class="center_right_title_gl" style="margin-top:5px;"href="messageindex.jsp">留言</a>
			     </div>
