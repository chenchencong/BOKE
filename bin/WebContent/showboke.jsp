...
<body>
	...
	<div class="comment_outer">
		<div class="comment_inner">	
			<form action="comment_submit" method="post" onsubmit="return checkinfo()">
			
					<textarea id="content"class="comment" rows="3" cols="20" name="content"></textarea>
				     <div class="sr">
				    <div  class="submit"value="立即提交" /><input type="reset" class="abandon"value="舍弃" />
				    </div>
